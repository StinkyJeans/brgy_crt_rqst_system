...
export default function Page() {
  ...
  useEffect(() => {
    ...
    setDocumentTitle('Barangay Residency');
  }, []);
    ...
    try {
      const res = await fetch('/api/certificates', {
        ...
        body: JSON.stringify({
          ...
          email,
          purpose,
          documentTitle: 'Barangay Residency', 
        }),
      });
  ...
  return (
    <div className="h-auto mb-10">
      ...
      <label className="ml-[45%] font-semibold font-sans">Barangay Residency</label>
      <div className="grid grid-cols-2 gap-5 ">
        <div>
          <img src="/Residency.jpg" alt="Logo" className="h-50  w-auto mt-20"></img>
        </div>
        <div className="font-mono mt-20">
        Barangay Residency: Barangay residency refers to the legal status of being a resident of 
        a specific barangay in the Philippines. Proof of barangay residency is often required for 
        various transactions and services within the barangay, such as obtaining barangay clearances, 
        voting in barangay elections, or accessing barangay programs.
